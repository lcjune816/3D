...
namespace Engine
{
	...
	enum class RENDERGROUP { PRIORITY, NONBLEND, NONLIGHT,BLEND,BLOOM_BEFORE,BLOOM, UI,FONT,END };
	enum class STATE { RIGHT, UP, LOOK, POS, END };
	enum class MESH_TYPE { ANIME, NONANIME, TRIGGER ,DECAL,NAVI,END };
	enum class D3DTS   {VIEW, PROJ, END};
	enum class FSM     {IDLE, MOVE, JUMP,CROUCH, HAND,PULL_HAND, SPAWN, DEAD, END};
	...
	enum class DEFERRED {DEBUG, DIRECTIOANL, POINT, COMBINED, SPOTLIGHT,LINE,FOG, BLOOM, BLURHORIZON, BLURVERTICAL
						,DOWNSAMPLE2,DOWNSAMPLE4,UPSAMPLE2,UPSAMPLE4,HELP,END};
	...
	enum class CHANNELID { SOUND_BGM01, SOUND_BGM02, SOUND_BGM03,PLAYER_MOVE,PLAYER_EFFECT, 
		...
		SOUND_OBJECT2, SOUND_OBJECT3, SOUND_OBJECT4,
