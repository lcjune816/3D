...
private:
	...
	HRESULT					Load_LightsData(LEVEL eLevel, const _wstring& strPrototypeTag, uint32_t iPrototypeLevel, const _wstring& strLoadFilePathName, const string& strjsonKeyName);
private:
	HANDLE					m_hThread = {};
