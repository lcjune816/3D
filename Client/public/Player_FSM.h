...
enum class FSM_HAND_FLAG { ATTACHED = 0x00000001, R = 0x00000002, PULL = 0x00000004, PULLEND = 0x00000008, WALLCOLLIDE = 0x00000010, TIMER = 0x00000020 , PAUSE = 0x00000040,
	SHOT = 0x00000080,ALL_STOP = 0x00000100,END = 0xffffffff };

enum class CHANGE_STATE { ATTACHED_LONG, ATTACHED_SHORT, PULL, PAUSE, END };
NS_BEGIN(Engine)
