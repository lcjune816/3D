...
// 
enum class PLAYER_ANIME {CROUCH_ENTER, CROUCH_EXIT, CROUCH_POSE, FALLING, SHOOT_FLARE,
						SHOOT_IN, SHOOT_OUT, HAND_SWITCH, IDLE, JUMP, LAND, LOWER, DIR_BACKWARD,
						DIR_FOWARD, DIR_LEFT,DIR_RIGHT,CATDEATH2, RAISE,RUN, WALK,WALK_STOP,
...
private:
	...
	shared_ptr<Engine::CFSM_Machine>	m_pStateMachine[ETOUI(PLAYER_MACHINE::END)];
